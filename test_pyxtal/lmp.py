...
class LMP:
    ...
    def __init__(
        ...
        self.prefix = prefix
        self.label = label
        self.in = self.prefix + ".in"
        self.dat = self.label + self.prefix + ".dat"
    ...
    def execute(self):
        cmd = self.exe + " -in " + self.input + " -log " + self.output
        # os.system(cmd)
    ...
    def clean(self):
        ...
        os.remove(self.in) if os.path.exists(self.in) else None
